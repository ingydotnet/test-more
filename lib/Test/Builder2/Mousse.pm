# This file was generated by Test::Builder2::Mousse::Maker 0.12 from Mouse 0.87.
#
# ANY CHANGES MADE HERE WILL BE LOST!
use strict;
use warnings;

# tell Perl we already have all of the Test::Builder2::Mousse files loaded:
BEGIN {
	$INC{'Test/Builder2/Mousse.pm'}                             = __FILE__;
	$INC{'Test/Builder2/Mousse/Role.pm'}                        = __FILE__;
	$INC{'Test/Builder2/Mousse/Util.pm'}                        = __FILE__;
	$INC{'Test/Builder2/Mousse/Exporter.pm'}                    = __FILE__;
	$INC{'Test/Builder2/Mousse/PurePerl.pm'}                    = __FILE__;
	$INC{'Test/Builder2/Mousse/Object.pm'}                      = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Class.pm'}                  = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Method.pm'}                 = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/TypeConstraint.pm'}         = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Attribute.pm'}              = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Role.pm'}                   = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Module.pm'}                 = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Method/Delegation.pm'}      = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Method/Destructor.pm'}      = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Method/Accessor.pm'}        = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Method/Constructor.pm'}     = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Role/Method.pm'}            = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Role/Composite.pm'}         = __FILE__;
	$INC{'Test/Builder2/Mousse/Meta/Role/Application.pm'}       = __FILE__;
	$INC{'Test/Builder2/Mousse/Util/TypeConstraints.pm'}        = __FILE__;
	$INC{'Test/Builder2/Mousse/Util/MetaRole.pm'}               = __FILE__;
}

# and now their contents

# Contents of Mouse::PurePerl
package Test::Builder2::Mousse::PurePerl;
# The pure Perl backend for Mousse
package Test::Builder2::Mousse::Util;
use strict;
use warnings;
use warnings FATAL => 'redefine'; # to avoid to load Test::Builder2::Mousse::PurePerl twice

use Scalar::Util ();
use B ();

require Test::Builder2::Mousse::Util;
...
sub generate_isa_predicate_for {
	...
	if(defined $name){
		Test::Builder2::Mousse::Util::install_subroutines(scalar caller, $name => $predicate);
		return;
	}
...
package Test::Builder2::Mousse::Util::TypeConstraints;
...
sub ClassName  { Test::Builder2::Mousse::Util::is_class_loaded($_[0]) }
sub RoleName   { (Test::Builder2::Mousse::Util::class_of($_[0]) || return 0)->isa('Test::Builder2::Mousse::Meta::Role') }
...
package Test::Builder2::Mousse::Meta::Module;
...
sub add_method {
	...
	Test::Builder2::Mousse::Util::install_subroutines($self->name,
		$name => $code,
	);
	return;
}
...
my $generate_class_accessor = sub {
	...
	return sub {
		...
		foreach my $class($self->linearized_isa) {
			my $meta = Test::Builder2::Mousse::Util::get_metaclass_by_name($class)
				or next;
...
package Test::Builder2::Mousse::Meta::Class;

use Test::Builder2::Mousse::Meta::Method::Constructor;
use Test::Builder2::Mousse::Meta::Method::Destructor;

sub method_metaclass    { $_[0]->{method_metaclass}    || 'Test::Builder2::Mousse::Meta::Method'    }
sub attribute_metaclass { $_[0]->{attribute_metaclass} || 'Test::Builder2::Mousse::Meta::Attribute' }

sub constructor_class { $_[0]->{constructor_class} || 'Test::Builder2::Mousse::Meta::Method::Constructor' }
sub destructor_class  { $_[0]->{destructor_class}  || 'Test::Builder2::Mousse::Meta::Method::Destructor'  }
...
sub linearized_isa { @{ Test::Builder2::Mousse::Util::get_linear_isa($_[0]->{package}) } }
...
sub new_object {
	...
	if( $object->can('BUILD') ) {
		for my $class (reverse $meta->linearized_isa) {
			my $build = Test::Builder2::Mousse::Util::get_code_ref($class, 'BUILD')
				|| next;
...
sub clone_object {
	my $class  = shift;
	my $object = shift;
	my $args   = $object->Test::Builder2::Mousse::Object::BUILDARGS(@_);
...
sub _initialize_object{
	...
	# when an attribute is added. See Test::Builder2::Mousse::Meta::Class::add_attribute.
	my $initializer = $self->{_mouse_cache}{_initialize_object} ||=
		Test::Builder2::Mousse::Util::load_class($self->constructor_class)
...
sub _report_unknown_args {
	...
	$metaclass->throw_error( sprintf
		...
		$metaclass->name, Test::Builder2::Mousse::Util::english_list(@unknowns),
	);
}

package Test::Builder2::Mousse::Meta::Role;

sub method_metaclass{ $_[0]->{method_metaclass} || 'Test::Builder2::Mousse::Meta::Role::Method' }
...
package Test::Builder2::Mousse::Meta::Attribute;

require Test::Builder2::Mousse::Meta::Method::Accessor;

sub accessor_metaclass{ $_[0]->{accessor_metaclass} || 'Test::Builder2::Mousse::Meta::Method::Accessor' }
...
sub _process_options{
	...
	if(exists $args->{builder}){
		# XXX:
		# Moose refuses a CODE ref builder, but Test::Builder2::Mousse doesn't for backward compatibility
	...
	# taken from Test::Builder2::Mousse::Meta::Attribute->new and ->_process_args
	...
	my $tc;
	if(exists $args->{isa}){
		$tc = $args->{type_constraint} = Test::Builder2::Mousse::Util::TypeConstraints::find_or_create_isa_type_constraint($args->{isa});
	}
	...
	if(exists $args->{does}){
		if(defined $tc){ # both isa and does supplied
			...
			$tc = $args->{type_constraint} = Test::Builder2::Mousse::Util::TypeConstraints::find_or_create_does_type_constraint($args->{does});
		}
	}
...
package Test::Builder2::Mousse::Meta::TypeConstraint;
...
sub compile_type_constraint{
	...
	if(@checks == 0){
		$self->{compiled_type_constraint} = \&Test::Builder2::Mousse::Util::TypeConstraints::Any;
	}
	else{
...
package Test::Builder2::Mousse::Object;
...
sub DESTROY {
	...
	my $e = do{
		...
		eval{
			...
			foreach my $class (@{ Test::Builder2::Mousse::Util::get_linear_isa(ref $self) }) {
				my $demolish = Test::Builder2::Mousse::Util::get_code_ref($class, 'DEMOLISH')
					|| next;

				$self->$demolish($Test::Builder2::Mousse::Util::in_global_destruction);
			}
		};
		$@;
	};
...
package Test::Builder2::Mousse::Exporter;
use strict;
use warnings;
...
# it must be "require", because Test::Builder2::Mousse::Util depends on Test::Builder2::Mousse::Exporter,
# which depends on Test::Builder2::Mousse::Util::import()
require Test::Builder2::Mousse::Util;
...
sub setup_import_methods{
	...
	Test::Builder2::Mousse::Util::install_subroutines($exporting_package,
		import   => $import,
		unimport => $unimport,
	...
	foreach my $package(@export_from){
		...
		if(my $as_is = $spec->{as_is}){
			foreach my $thingy (@{$as_is}){
				...
				if(ref($thingy)){
					$code = $thingy;
					($code_package, $code_name) = Test::Builder2::Mousse::Util::get_code_info($code);
				}
				else{
...
sub do_import {
	...
	my $spec = $SPEC{$package}
		|| Carp::confess("The package $package package does not use Test::Builder2::Mousse::Exporter");
	...
	while(@args){
		...
		if($arg =~ s/^-//){
			if($arg eq 'traits'){
				...
				Test::Builder2::Mousse::Util::not_supported("-$arg");
			}
		}
		elsif($arg =~ s/^://){
	...
	if($spec->{INIT_META}){
		...
		if(@traits){
			...
			@traits = map{
			  ref($_)
				? $_
				: Test::Builder2::Mousse::Util::resolve_metaclass_alias($type => $_, trait => 1)
			} @traits;

			require Test::Builder2::Mousse::Util::MetaRole;
			Test::Builder2::Mousse::Util::MetaRole::apply_metaroles(
				for       => $into,
				Test::Builder2::Mousse::Util::is_a_metarole($into->meta)
	...
	if(@exports){
		...
		Test::Builder2::Mousse::Util::install_subroutines($into, @export_table);
	}
	else{
		Test::Builder2::Mousse::Util::install_subroutines($into, %{$spec->{DEFAULT}});
	}
	return;
}
...
sub do_unimport {
	...
	my $spec = $SPEC{$package}
		|| Carp::confess("The package $package does not use Test::Builder2::Mousse::Exporter");
...
package Test::Builder2::Mousse::Util;
use Test::Builder2::Mousse::Exporter; # enables strict and warnings
no warnings 'once';

# must be here because it will be refered by other modules loaded
sub get_linear_isa($;$); ## no critic

# must be here because it will called in Test::Builder2::Mousse::Exporter
...
BEGIN{
	# This is used in Test::Builder2::Mousse::PurePerl
	...
	# Because Test::Builder2::Mousse::Util is loaded first in all the Test::Builder2::Mousse sub-modules,
	# XSLoader must be placed here, not in Test/Builder2/Mousse.pm.
	if($xs){
		# XXX: XSLoader tries to get the object path from caller's file name
		#      $hack_mouse_file fools its mechanism
		(my $hack_mouse_file = __FILE__) =~ s/.Util//; # .../Test/Builder2/Mousse/Util.pm -> .../Test/Builder2/Mousse.pm
		$xs = eval sprintf("#line %d %s\n", __LINE__, $hack_mouse_file) . q{
			local $^W = 0; # workaround 'redefine' warning to &install_subroutines
			require XSLoader;
			XSLoader::load('Test::Builder2::Mousse', $VERSION);
			Test::Builder2::Mousse::Util->import({ into => 'Test::Builder2::Mousse::Meta::Method::Constructor::XS' }, ':meta');
			Test::Builder2::Mousse::Util->import({ into => 'Test::Builder2::Mousse::Meta::Method::Destructor::XS'  }, ':meta');
			Test::Builder2::Mousse::Util->import({ into => 'Test::Builder2::Mousse::Meta::Method::Accessor::XS'    }, ':meta');
			return 1;
		} || 0;
	...
	if(!$xs){
		require 'Test/Builder2/Mousse/PurePerl.pm'; # we don't want to create its namespace
	}
...
# it must be 'require', not 'use', because Test::Builder2::Mousse::Meta::Module depends on Test::Builder2::Mousse::Util
require Test::Builder2::Mousse::Meta::Module; # for the entities of metaclass cache utilities

# aliases
{
	*class_of                    = \&Test::Builder2::Mousse::Meta::Module::_class_of;
	*get_metaclass_by_name       = \&Test::Builder2::Mousse::Meta::Module::_get_metaclass_by_name;
	*get_all_metaclass_instances = \&Test::Builder2::Mousse::Meta::Module::_get_all_metaclass_instances;
	*get_all_metaclass_names     = \&Test::Builder2::Mousse::Meta::Module::_get_all_metaclass_names;

	*Test::Builder2::Mousse::load_class           = \&load_class;
	*Test::Builder2::Mousse::is_class_loaded      = \&is_class_loaded;

	# is-a predicates
	#generate_isa_predicate_for('Test::Builder2::Mousse::Meta::TypeConstraint' => 'is_a_type_constraint');
	#generate_isa_predicate_for('Test::Builder2::Mousse::Meta::Class'          => 'is_a_metaclass');
	#generate_isa_predicate_for('Test::Builder2::Mousse::Meta::Role'           => 'is_a_metarole');
...
sub does_role{
	...
	(defined $role_name)
		|| ($meta || 'Test::Builder2::Mousse::Meta::Class')->throw_error("You must supply a role name to does()");
...
# taken from Test::Builder2::Mousse::Util (0.90)
{
	my %cache;
	...
	sub resolve_metaclass_alias {
		...
		return $cache{$cache_key}{$metaclass_name} ||= do{
			...
			my $possible_full_name = join '::',
				'Test::Builder2::Mousse::Meta', $type, 'Custom', ($options{trait} ? 'Trait' : ()), $metaclass_name
			;
...
sub apply_all_roles {
	my $consumer = Scalar::Util::blessed($_[0])
		?                                $_[0]   # instance
		: Test::Builder2::Mousse::Meta::Class->initialize($_[0]); # class or role name
	...
	for (my $i = 1; $i < $max ; $i++) {
		...
		is_a_metarole($role)
			|| $consumer->meta->throw_error("You can only consume roles, $role_name is not a Test::Builder2::Mousse role");
	}
	...
	if ( scalar @roles == 1 ) {
		...
		Test::Builder2::Mousse::Meta::Role->combine(@roles)->apply($consumer);
	}
	return;
}
...
sub not_supported{
	...
	Carp::confess("Test::Builder2::Mousse does not currently support $feature");
}

# general meta() method
sub meta :method{
	return Test::Builder2::Mousse::Meta::Class->initialize(ref($_[0]) || $_[0]);
}
...
package Test::Builder2::Mousse::Meta::TypeConstraint;
use Test::Builder2::Mousse::Util qw(:meta); # enables strict and warnings
...
sub _add_type_coercions { # ($self, @pairs)
	...
	for(my $i = 0; $i < @_; $i++){
		...
		my $type = Test::Builder2::Mousse::Util::TypeConstraints::find_or_parse_type_constraint($from)
			or $self->throw_error(
...
sub parameterize {
	...
	if(!ref $param){
		require Test::Builder2::Mousse::Util::TypeConstraints;
		$param = Test::Builder2::Mousse::Util::TypeConstraints::find_or_create_isa_type_constraint($param);
	}

	$name ||= sprintf '%s[%s]', $self->name, $param->name;
	return Test::Builder2::Mousse::Meta::TypeConstraint->new(
		name           => $name,
		parent         => $self,
...
sub _unite { # overload infix:<|>
	my($lhs, $rhs) = @_;
	require Test::Builder2::Mousse::Util::TypeConstraints;
	return Test::Builder2::Mousse::Util::TypeConstraints::_find_or_create_union_type(
		$lhs,
		Test::Builder2::Mousse::Util::TypeConstraints::find_or_create_isa_type_constraint($rhs),
	);
}

# Contents of Mouse::Util::TypeConstraints
package Test::Builder2::Mousse::Util::TypeConstraints;
use Test::Builder2::Mousse::Util; # enables strict and warnings

use Test::Builder2::Mousse::Meta::TypeConstraint;
...
our @CARP_NOT = qw(Test::Builder2::Mousse::Meta::Attribute);

my %TYPE;

# The root type
$TYPE{Any} = Test::Builder2::Mousse::Meta::TypeConstraint->new(
	name => 'Any',
);
...
while (my ($name, $parent, $code) = splice @builtins, 0, 3) {
	$TYPE{$name} = Test::Builder2::Mousse::Meta::TypeConstraint->new(
		name      => $name,
		parent    => $TYPE{$parent},
		optimized => $code,
	);
...
sub _define_type {
	...
	if(defined $name){
		...
		if(!$this){
			$this = caller(1);
			if($this !~ /\A Test::Builder2::Mousse \b/xms){
	...
	my $constraint = Test::Builder2::Mousse::Meta::TypeConstraint->new(%args);
...
sub class_type {
	...
	return subtype $name => (
		as           => 'Object',
		optimized_as => Test::Builder2::Mousse::Util::generate_isa_predicate_for($class),
		class        => $class,
	);
}
	...
	return subtype $name => (
		...
		optimized_as => sub {
			return Scalar::Util::blessed($_[0])
				&& Test::Builder2::Mousse::Util::does_role($_[0], $role);
		},
		role         => $role,
	);
}
...
sub duck_type {
	...
	return _define_type 1, $name => (
		as           => 'Object',
		optimized_as => Test::Builder2::Mousse::Util::generate_can_predicate_for(\@methods),
		message      => sub {
			my($object) = @_;
			my @missing = grep { !$object->can($_) } @methods;
			return ref($object)
				. ' is missing methods '
				. Test::Builder2::Mousse::Util::quoted_english_list(@missing);
		},
		methods      => \@methods,
	);
}
...
sub _find_or_create_regular_type{
	...
	my $meta = Test::Builder2::Mousse::Util::get_metaclass_by_name($spec);

	if(!defined $meta){
		return $create ? class_type($spec) : undef;
	}

	if(Test::Builder2::Mousse::Util::is_a_metarole($meta)){
...
sub find_type_constraint {
	my($spec) = @_;
	return $spec if Test::Builder2::Mousse::Util::is_a_type_constraint($spec) or not defined $spec;
...
sub register_type_constraint {
	...
	Carp::croak("No type supplied / type is not a valid type constraint")
		unless Test::Builder2::Mousse::Util::is_a_type_constraint($constraint);
...
sub find_or_create_does_type_constraint{
	# XXX: Moose does not register a new role_type, but Test::Builder2::Mousse does.
	my $tc = find_or_parse_type_constraint(@_);
	return defined($tc) ? $tc : role_type(@_);
}

sub find_or_create_isa_type_constraint {
	# XXX: Moose does not register a new class_type, but Test::Builder2::Mousse does.
	my $tc = find_or_parse_type_constraint(@_);
	return defined($tc) ? $tc : class_type(@_);
}

# Contents of Mouse
package Test::Builder2::Mousse::TOP;
use 5.006_002;
...
use Test::Builder2::Mousse::Util ();

use Test::Builder2::Mousse::Meta::Module;
use Test::Builder2::Mousse::Meta::Class;
use Test::Builder2::Mousse::Meta::Role;
use Test::Builder2::Mousse::Meta::Attribute;
use Test::Builder2::Mousse::Object;
...
sub extends {
	Test::Builder2::Mousse::Meta::Class->initialize(scalar caller)->superclasses(@_);
	return;
}

sub with {
	Test::Builder2::Mousse::Util::apply_all_roles(scalar(caller), @_);
	return;
}

sub has {
	my $meta = Test::Builder2::Mousse::Meta::Class->initialize(scalar caller);
	my $name = shift;
...
sub override {
	# my($name, $method) = @_;
	Test::Builder2::Mousse::Meta::Class->initialize(scalar caller)->add_override_method_modifier(@_);
}
...
sub augment {
	#my($name, $method) = @_;
	Test::Builder2::Mousse::Meta::Class->initialize(scalar caller)->add_augment_method_modifier(@_);
	return;
}
...
sub init_meta {
	...
	my $base_class = $args{base_class} || 'Test::Builder2::Mousse::Object';
	my $metaclass  = $args{metaclass}  || 'Test::Builder2::Mousse::Meta::Class';
	...
	# make a class type for each Test::Builder2::Mousse class
	Test::Builder2::Mousse::Util::TypeConstraints::class_type($class)
		unless Test::Builder2::Mousse::Util::TypeConstraints::find_type_constraint($class);
...
my %valid_options = map { $_ => undef } (
  ...
  # Moose defines, but Test::Builder2::Mousse doesn't
  #'definition_context',
  #'initializer',
...
our @CARP_NOT = qw(Test::Builder2::Mousse::Meta::Class);

sub new {
	my $class = shift;
	my $name  = shift;

	my $args  = $class->Test::Builder2::Mousse::Object::BUILDARGS(@_);
	...
	if(@bad){
		Carp::carp(
			...
			. Test::Builder2::Mousse::Util::english_list(@bad));
	}
...
sub interpolate_class{
	...
	if(my $metaclass = delete $args->{metaclass}){
		$class = Test::Builder2::Mousse::Util::resolve_metaclass_alias( Attribute => $metaclass );
	}
	...
	if(my $traits_ref = delete $args->{traits}){
		...
		for (my $i = 0; $i < @{$traits_ref}; $i++) {
			my $trait = Test::Builder2::Mousse::Util::resolve_metaclass_alias(Attribute => $traits_ref->[$i], trait => 1);
		...
		if (@traits) {
			$class = Test::Builder2::Mousse::Meta::Class->create_anon_class(
				superclasses => [ $class ],
				roles        => \@traits,
				cache        => 1,
			)->name;
...
sub clone_and_inherit_options{
	my $self = shift;
	my $args = $self->Test::Builder2::Mousse::Object::BUILDARGS(@_);
...
sub install_accessors{
	...
	if(exists $attribute->{handles}){
		...
		while(my($handle, $method_to_call) = each %handles){
			next if Test::Builder2::Mousse::Object->can($handle);
...
sub delegation_metaclass() { ## no critic
	'Test::Builder2::Mousse::Meta::Method::Delegation'
}
...
sub _canonicalize_handles {
	...
	if ($handle_type eq 'HASH') {
		...
		return map  { $_ => $_ }
			   grep { /$handles/ }
				   Test::Builder2::Mousse::Util::is_a_metarole($meta)
...
sub _find_delegate_metaclass {
	...
	my $meta;
	if($self->{isa}) {
		$meta = Test::Builder2::Mousse::Meta::Class->initialize("$self->{isa}");
	}
	elsif($self->{does}) {
		$meta = Test::Builder2::Mousse::Util::get_metaclass_by_name("$self->{does}");
	}
...
sub _make_delegation_method {
	...
	return Test::Builder2::Mousse::Util::load_class($self->delegation_metaclass)
...
use Test::Builder2::Mousse::Meta::Module;
our @ISA = qw(Test::Builder2::Mousse::Meta::Module);

our @CARP_NOT = qw(Test::Builder2::Mousse); # trust Mousse
...
sub superclasses {
	...
	if (@_) {
		foreach my $super(@_){
			Test::Builder2::Mousse::Util::load_class($super);
			my $meta = Test::Builder2::Mousse::Util::get_metaclass_by_name($super);
...
sub verify_superclass {
	...
	if(defined $super_meta) {
		if(Test::Builder2::Mousse::Util::is_a_metarole($super_meta)){
			$self->throw_error("You cannot inherit from a Test::Builder2::Mousse Role ($super)");
		}
	}
	else {
		# The metaclass of $super is not initialized.
		# i.e. it might be Test::Builder2::Mousse::Object, a mixin package (e.g. Exporter),
		# or a foreign class including Moose classes.
		# See also Test::Builder2::Mousse::Foreign::Meta::Role::Class.
		my $mm = $super->can('meta');
		if(!($mm && $mm == \&Test::Builder2::Mousse::Util::meta)) {
...
sub inherit_from_foreign_class {
	my($class, $super) = @_;
	Carp::carp("You inherit from non-Test::Builder2::Mousse class ($super),"
		. " but it is unlikely to work correctly."
		. " Please consider using Test::Builder2::MousseX::Foreign");
	return;
}

my @MetaClassTypes = (
	'attribute',   # Test::Builder2::Mousse::Meta::Attribute
	'method',      # Test::Builder2::Mousse::Meta::Method
	'constructor', # Test::Builder2::Mousse::Meta::Method::Constructor
	'destructor',  # Test::Builder2::Mousse::Meta::Method::Destructor
);
...
sub _reconcile_with_superclass_meta {
	...
	require Test::Builder2::Mousse::Util::MetaRole;
	$_[0] = Test::Builder2::Mousse::Util::MetaRole::apply_metaroles(
		for             => $self,
...
sub get_all_method_names {
	...
	return grep { $uniq{$_}++ == 0 }
			map { Test::Builder2::Mousse::Meta::Class->initialize($_)->get_method_list() }
			$self->linearized_isa;
}
...
sub add_attribute {
	...
	if(Scalar::Util::blessed($_[0])){
		...
		$attr->isa('Test::Builder2::Mousse::Meta::Attribute')
			|| $self->throw_error("Your attribute must be an instance of Test::Builder2::Mousse::Meta::Attribute (or a subclass)");
...
sub _calculate_all_attributes {
	...
	my @all_attrs;
	foreach my $class($self->linearized_isa) {
		my $meta  = Test::Builder2::Mousse::Util::get_metaclass_by_name($class) or next;
...
sub make_immutable {
	...
	if ($args{inline_destructor}) {
		$self->add_method(DESTROY =>
			Test::Builder2::Mousse::Util::load_class($self->destructor_class)
...
sub add_override_method_modifier {
	...
	$self->add_method($name => sub {
		local $Test::Builder2::Mousse::SUPER_PACKAGE = $package;
		local $Test::Builder2::Mousse::SUPER_BODY    = $super_body;
		local @Test::Builder2::Mousse::SUPER_ARGS    = @_;
		&{$code};
	});
	return;
}
...
sub add_augment_method_modifier {
	...
	$self->add_method($name => sub {
		local $Test::Builder2::Mousse::INNER_BODY{$super_package} = $code;
		local $Test::Builder2::Mousse::INNER_ARGS{$super_package} = [@_];
		&{$super_body};
	});
	return;
}
...
package Test::Builder2::Mousse::Meta::Method;
use Test::Builder2::Mousse::Util qw(:meta); # enables strict and warnings
use Scalar::Util ();
...
package Test::Builder2::Mousse::Meta::Method::Accessor;
use Test::Builder2::Mousse::Util qw(:meta); # enables strict and warnings
...
package Test::Builder2::Mousse::Meta::Method::Constructor;
use Test::Builder2::Mousse::Util qw(:meta); # enables strict and warnings
...
sub _generate_BUILDARGS {
	...
	if ( $class->can('BUILDARGS') && $class->can('BUILDARGS') != \&Test::Builder2::Mousse::Object::BUILDARGS ) {
...
sub _generate_BUILDALL {
	...
	for my $class ($metaclass->linearized_isa) {
		if (Test::Builder2::Mousse::Util::get_code_ref($class, 'BUILD')) {
...
package Test::Builder2::Mousse::Meta::Method::Delegation;
use Test::Builder2::Mousse::Util qw(:meta); # enables strict and warnings
use Scalar::Util;
...
package Test::Builder2::Mousse::Meta::Method::Destructor;
use Test::Builder2::Mousse::Util qw(:meta); # enables strict and warnings
...
sub _generate_destructor{
	...
	my $demolishall = '';
	for my $class ($metaclass->linearized_isa) {
		if (Test::Builder2::Mousse::Util::get_code_ref($class, 'DEMOLISH')) {
			$demolishall .= '                ' . $class
				. '::DEMOLISH($self, $Test::Builder2::Mousse::Util::in_global_destruction);'
				. "\n",
		}
	}
...
#line 1 "%s"
	...
	sub {
		my($self) = @_;
		return $self->Test::Builder2::Mousse::Object::DESTROY()
			if ref($self) ne __PACKAGE__;
		# DEMOLISHALL
		%s;
		return;
...
if(Test::Builder2::Mousse::Util::MOUSE_XS){
	# register meta storage for performance
	Test::Builder2::Mousse::Util::__register_metaclass_storage(\%METAS, 0);

	# ensure thread safety
	*CLONE = sub { Test::Builder2::Mousse::Util::__register_metaclass_storage(\%METAS, 1) };
}
...
# The public versions are aliased into Test::Builder2::Mousse::Util::*.
...
my %foreign = map{ $_ => undef } qw(
	Test::Builder2::Mousse Test::Builder2::Mousse::Role Test::Builder2::Mousse::Util Test::Builder2::Mousse::Util::TypeConstraints
	Carp Scalar::Util List::Util
);
sub _get_method_body {
	my($self, $method_name) = @_;
	my $code = Test::Builder2::Mousse::Util::get_code_ref($self->{package}, $method_name);
	return $code && !exists $foreign{ Test::Builder2::Mousse::Util::get_code_package($code) }
		? $code
		: undef;
}
...
sub get_method {
	...
	if(my $code = $self->get_method_body($method_name)){
		return Test::Builder2::Mousse::Util::load_class($self->method_metaclass)->wrap(
			body                 => $code,
			name                 => $method_name,
			package              => $self->name,
...
sub _collect_methods { # Test::Builder2::Mousse specific, used for method modifiers
	my($meta, @args) = @_;
...
sub create {
	...
	if(exists $options{superclasses}){
		if(Test::Builder2::Mousse::Util::is_a_metarole($self)){
	...
	if (defined $attributes) {
		if(ref($attributes) eq 'ARRAY'){
			# array of Test::Builder2::Mousse::Meta::Attribute
	...
	if (defined $roles and !$options{in_application_to_instance}){
		Test::Builder2::Mousse::Util::apply_all_roles($package_name, @{$roles});
	}
...
sub DESTROY{
	...
	return if $Test::Builder2::Mousse::Util::in_global_destruction;
...
sub apply {
	...
	require 'Test/Builder2/Mousse/Meta/Role/Application.pm';
	return Test::Builder2::Mousse::Meta::Role::Application->new(@_)->apply($self, $consumer);
}

sub combine {
	my($self, @role_specs) = @_;

	require 'Test/Builder2/Mousse/Meta/Role/Composite.pm';
	return Test::Builder2::Mousse::Meta::Role::Composite->new(roles => \@role_specs);
}
...
package Test::Builder2::Mousse::Meta::Role::Application;
use Test::Builder2::Mousse::Util qw(:meta);
...
sub apply {
	...
	if(Test::Builder2::Mousse::Util::is_a_metaclass($consumer)) {   # Application::ToClass
		$self->{_to} = 'class';
	}
	elsif(Test::Builder2::Mousse::Util::is_a_metarole($consumer)) { # Application::ToRole
		$self->{_to} = 'role';
	}
		...
		$consumer = (Test::Builder2::Mousse::Util::class_of($instance) || 'Test::Builder2::Mousse::Meta::Class')
			->create_anon_class(
...
package Test::Builder2::Mousse::Meta::Role::Composite;
use Test::Builder2::Mousse::Util; # enables strict and warnings
use Test::Builder2::Mousse::Meta::Role;
use Test::Builder2::Mousse::Meta::Role::Application;
our @ISA = qw(Test::Builder2::Mousse::Meta::Role);

# FIXME: Test::Builder2::Mousse::Meta::Role::Composite does things in different way from Moose's
# Moose: creates a new class for the consumer, and applies roles to it.
# Test::Builder2::Mousse: creates a coposite role and apply roles to the role,
...
sub apply {
	...
	Test::Builder2::Mousse::Meta::Role::Application::RoleSummation->new(@_)->apply($self, $consumer);
	return;
}

package Test::Builder2::Mousse::Meta::Role::Application::RoleSummation;
our @ISA = qw(Test::Builder2::Mousse::Meta::Role::Application);
...
sub apply_methods {
	...
	if(exists $role->{conflicting_methods}){
		...
		if(@conflicting) {
			...
			my %seen;
			my $roles = Test::Builder2::Mousse::Util::quoted_english_list(
				grep{ !$seen{$_}++ } # uniq
				map { $_->name }
				map { @{$_} }
			...
			$self->throw_error(sprintf
				...
				. q{ the method%s %s must be implemented or excluded by '%s'},
					...
					$roles,
					(@conflicting > 1 ? 's' : ''),
					Test::Builder2::Mousse::Util::quoted_english_list(@conflicting),
					$consumer_class_name);
		}
	}
...
package Test::Builder2::Mousse::Meta::Role::Method;
use Test::Builder2::Mousse::Util; # enables strict and warnings

use Test::Builder2::Mousse::Meta::Method;
our @ISA = qw(Test::Builder2::Mousse::Meta::Method);
...
package Test::Builder2::Mousse::Object;
use Test::Builder2::Mousse::Util qw(does dump meta); # enables strict and warnings
# all the stuff are defined in XS or PP
# Contents of Mouse::Role
package Test::Builder2::Mousse::Role;
use Test::Builder2::Mousse::Exporter; # enables strict and warnings
...
sub has {
	my $meta = Test::Builder2::Mousse::Meta::Role->initialize(scalar caller);
	my $name = shift;
...
sub super {
	return if !defined $Test::Builder2::Mousse::SUPER_BODY;
	$Test::Builder2::Mousse::SUPER_BODY->(@Test::Builder2::Mousse::SUPER_ARGS);
}

sub override {
	# my($name, $code) = @_;
	Test::Builder2::Mousse::Meta::Role->initialize(scalar caller)->add_override_method_modifier(@_);
	return;
}
...
sub excludes {
	Test::Builder2::Mousse::Util::not_supported();
}
...
sub init_meta{
	...
	my $metaclass  = $args{metaclass}  || 'Test::Builder2::Mousse::Meta::Role';
	...
	# make a role type for each Test::Builder2::Mousse role
	Test::Builder2::Mousse::Util::TypeConstraints::role_type($class)
		unless Test::Builder2::Mousse::Util::TypeConstraints::find_type_constraint($class);
...
package Test::Builder2::Mousse::Util::MetaRole;
use Test::Builder2::Mousse::Util; # enables strict and warnings
use Scalar::Util ();
...
sub apply_metaroles {
	...
	my $for = Scalar::Util::blessed($args{for})
		?                                     $args{for}
		: Test::Builder2::Mousse::Util::get_metaclass_by_name( $args{for} );

	if(!$for){
		Carp::confess("You must pass an initialized class, but '$args{for}' has no metaclass");
	}

	if ( Test::Builder2::Mousse::Util::is_a_metarole($for) ) {
...
sub _fixup_old_style_args {
	...
	my $top_key;
	if( Test::Builder2::Mousse::Util::is_a_metaclass($for) ){
...
sub apply_base_class_roles {
	...
	my $meta = Test::Builder2::Mousse::Util::class_of($for);
...
sub _make_new_class {
	...
	if(!$superclasses){
		...
		my $meta = Test::Builder2::Mousse::Meta::Class->initialize($existing_class);

		return $existing_class
			if !grep { !ref($_) && !$meta->does_role($_) } @{$roles};
	}

	return Test::Builder2::Mousse::Meta::Class->create_anon_class(
...
package Test::Builder2::Mousse;

our $VERSION = '0.12';

Test::Builder2::Mousse::Exporter->setup_import_methods(also => 'Test::Builder2::Mousse::TOP');
